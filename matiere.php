...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <div class="container ">
            ...
            <h1 class="text-center text-light">Matières</h1><br>
    <h3 class="text-center text-muted">Choisir une action:</h3>

    <button type="button" class="btn btn-outline-dark" style="margin:25px;" onclick="window.location.href = 'ajout_matiere.php';">Ajout</button>
    <button type="button" class="btn btn-outline-dark" style="margin:25px;" onclick="window.location.href = 'affich_modif_matiere.php';">Modification</button>
    <button type="button" class="btn btn-outline-dark" style="margin:25px;" onclick="window.location.href = 'affich_suppr_matiere.php';">Suppression</button>
            </div>
    </div>
