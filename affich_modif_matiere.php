  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item">
      <a class="nav-link" style="margin-left: 20px;" href="matiere.php">Matières</a>
        ...
        ?><br>
        <h3 class="text-center">Les matieres</h3>
        <h4>Il y a <?=$nbre_matiere?> nombres de matières</h4>
        <table class="table table-hover" style="border-color: transparent;">
            <thead>
            <tr>
                <th scope="col">Codemat</th>
            ...
            while ($ligne = $result->fetch(PDO::FETCH_NUM)){
               echo "<tr>";
                ...
                ?>
                <td>
                    <a href="modif_matiere.php?codemat=<?=$ligne[0]?>">Modifier</a>           
                </td>
                <?php
                echo "</tr>";
            }
