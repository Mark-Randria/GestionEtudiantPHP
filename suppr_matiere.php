...
<head>
    ...
    <title>Suppression d'une Matiere</title>
...
<form action="suppr_matiere.php" method="post">
<div class="container">
        ...
        <table class="mb-5">
            <tr>
                ...
                <td>
                <input class="form-control" type="text" name="adresse" size="50" value="<?=$data['libelle']?>" readonly>
                </td>            
            </tr>
            <tr>
                <td class="text-light">Coefficient : </td>
                <td>
                <input class="form-control" type="text" name="adresse" size="50" value="<?=$data['coef']?>" readonly>
                </td>            
            </tr>
    ...
    <input type="hidden" name="codemat" value="<?=$codemat?>">
        ...
        <?php
         ...
         $result->closeCursor();
            ...
            $requete = ("DELETE FROM matiere WHERE codemat='$codemat' ");
